        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <a href="<?php echo base_url();?>Mycontroller/viewmodule/<?php echo $r->course_id;?>"><img src="<?php echo base_url();?>upload/courses/<?php echo $r->thumbnail;?>" style="width: 400px; height:200px;" class="img-fluid" alt="..."></a>
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4><?php echo $r->course_name;?></h4>
                  
                </div>
                <h3><a href="<?php echo base_url();?>Mycontroller/viewmodule/<?php echo $r->course_id;?>"><?php echo $r->course_name;?></a></h3>
