   ...
   <section id="main-content">
      <section class="wrapper">
    		<div class="container">
		      ...
		      <form action="<?= base_url(); ?>Mycontroller/studentdochat" method="post">          
            <div class="col-sm-8">
                <div class="chatbody">
                    <div class="panel panel-primary">
		                ...
		                <div class="panel-heading top-bar">
		                    <div class="col-md-8 col-xs-8">
		                        <h3 class="panel-title"><span class="glyphicon glyphicon-comment"></span> Chat - to ADMIN</h3>
		                    </div>
		                </div>
                          ...
                          foreach($records2 as $r2)
                            {
                              foreach($records3 as $r3)
                                {
                                  if($r1->student_id==$this->session->userdata('student_id') )
                                    { 
                        ?>
		                    ...
		                    <div class="row msg_container base_sent">
		                        <div class="col-md-10 col-xs-10">
                                  ...
                                  <?php }elseif($r1->id == $r3->id){  ?>
                                    <time datetime="2009-11-13T20:00"><?php echo $r3->name;?>• <?php echo $r1->time;?></time>
                                   <?php } ?> 
		                            </div>
		                        </div>
		                ...
		                <div class="panel-footer">
		                    <div class="input-group">
		                        ...
		                        <input type="submit" class="btn btn-primary btn-sm" id="btn-chat"><i class="fa fa-send fa-1x" aria-hidden="true"></i>
		                        </span>
		                    </div>
		                </div>
