    ...
    <div id="page-wrap">
        <table width="100%" class="outline-table">
            ...
            <tbody>
                ...
                <tr class="border-bottom border-right center">
                <td width="20%" style="text-align:right;"><strong>Invoice No:</strong></td>
                <td width="80%" style="text-align:left;"><strong><?= $r1->invoice_no;?></strong></td>
                </tr>
                
                <tr class="border-bottom border-right center">
                <td width="20%" style="text-align:right;"><strong>Invoice Date:</strong></td>
                <td width="80%" style="text-align:left;"><strong><?php echo date("M d Y"); ?></strong></td>
                </tr>
                
                <tr class="border-bottom border-right center">
                <td width="20%" style="text-align:right;"><strong>GSTIN:</strong></td>
                <td width="80%" style="text-align:left;"><strong>19AABCW6316K1Z0</strong></td>
                </tr>
              
                <tr class="border-bottom border-right center">
                <td width="20%" style="text-align:right;"><strong>Code:</strong></td>
                <td width="80%" style="text-align:left;"><strong>19</strong></td>
            ...
            <tbody>
                ...
                <tr class="border-bottom border-right center">
                    <td width="10%" style="text-align:left;"><strong>Name:</strong></td>
                    <td width="40%" style="text-align:left;"><strong><?= $r->name;?></strong></td>
                    <td width="25%" style="text-align:left;"><strong></strong></td>
                    
                </tr>
                <tr class="border-bottom border-right center">
                    <td width="10%" style="text-align:left;"><strong>Address:</strong></td>
                    <td width="40%" style="text-align:left;"><strong><?= $r->address;?></strong></td>
                    <td width="25%">
                    <table>
                    <tr>
                ...
                <tr class="border-bottom border-right center">
                    <td width="10%" style="text-align:left;"><strong>State:</strong></td>
                    <td width="40%" style="text-align:left;"><strong>WestBengal</strong></td>
