...
<body class="login-img3-body">
  ...
  <div class="container">
    ...
    <form class="login-form" action="<?= base_url();?>Mycontroller/adminlogindo" method="post">
      ...
      <div class="login-wrap">
        ...
        <a href="<?= base_url();?>Accountant"class="btn btn-info btn-lg btn-block" >Accountant Login</a>
      </div>
    </form>
