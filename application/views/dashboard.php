      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="<?= base_url(); ?>Mycontroller/adminview">Home</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box purple-bg">
              ...
              <div class="title">Training Planning</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box red-bg">
              ...
              <div class="count">35</div>
              <div class="title">Developement Targets</div>
            </div>
            <!--/.info-box-->
          </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box lime-bg">
              ...
              <div class="count">5</div>
              <div class="title">Virtual Classroom</div>
            </div>
            <!--/.info-box-->
          </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box yellow-bg">
              ...
              <div class="title">Course Directory</div>
            </div>
            <!--/.info-box-->
          </div>
        ...
        <!--/.row-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              <i class="fa fa-folder-open fa-3"></i>
