    ...
    ?>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <a href="<?php echo base_url();?>Mycontroller/instructorviewmodule/<?php echo $r->course_id;?>"><img src="<?php echo base_url();?>upload/courses/<?php echo $r->thumbnail;?>" style="width: 400px; height:200px;" class="img-fluid" alt="..."></a>
              <div class="course-content">
                ...
                <h3><a href="<?php echo base_url();?>Mycontroller/instructorviewmodule/<?php echo $r->course_id;?>"><?php echo $r->course_name;?></a></h3>
