			...
			<div class="row" >
			  ...
			  <div class="column">
			    <img src="<?=base_url();?>assets2/assets/img/ciss-academy_logo.png" alt="Mountains" style="width: 2000px;">
					...
					<div class="stl_01" style="top: 46.1363em; left:6.0191em; font-weight: bold;"><span class="stl_11 stl_12" style="word-spacing:0.09em;">Date of Issue :<?= date('M d Y',strtotime($r1->date_of_issue));?>&nbsp;</span></div>
				</div>
			</div>
		</div>
		    <?php
