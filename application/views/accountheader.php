        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li>
                <a href="<?= base_url(); ?>Accountant/accountantlogout"><i class="icon_key_alt"></i> Log Out</a>
              </li>
            </ul>
          </li>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class="active">
            <a class="" href="<?= base_url();?>Mycontroller/addinvoice">
                          <i class="icon_house_alt"></i>
                          <span>Generate Invoice</span>
                      </a>
          </li>
          <li class="sub-menu">
            <a href="<?= base_url();?>Accountant/viewinvoice" class="">
