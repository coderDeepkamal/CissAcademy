...
<body class="login-img3-body">
  ...
  <div class="container">
    ...
    <form class="login-form" action="<?= base_url();?>Mycontroller/studentlogindo" method="post">
      ...
      <div class="login-wrap">
        ...
        <a href="<?= base_url();?>Mycontroller/studentsignup"class="btn btn-info btn-lg btn-block" >Signup</a>
      </div>
    </form>
