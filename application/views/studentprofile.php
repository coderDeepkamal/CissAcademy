...
<section id="main-content">
  <section class="wrapper">
    <div class="container bootstrap snippet">
      <form class="form" action="<?= base_url();?>Mycontroller/updatedostudentprofile" method="post" id="registrationForm" enctype="multipart/form-data">
        <div class="row">
            <div class="col-sm-10"><h1><?= $this->session->userdata('name'); ?></h1></div>
                      ...
                      <form class="form" action="#" method="post" id="registrationForm">
                          <div class="form-group">
                              ...
                              <div class="col-xs-6">
                                  ...
                                  <input type="text" class="form-control" name="name" id="first_name" placeholder="first name" value="<?= $r->name;?>" title="enter your first name if any.">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-xs-6">
                                <label for="password2"><h4>New Password</h4></label>
                                  <input type="password" class="form-control" name="password" id="password2" placeholder="password2" value="<?= $r->password;?>" title="enter your password.">
                              </div>
                          </div>
                          <div class="form-group">
                               <div class="col-xs-12">
