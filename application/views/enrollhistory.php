...
<div class="row">
          ...
          <div class="container-fluid">
           <div class="row">  
                ...
                <?php
                  foreach($records as $r)
                  {
                    ...
                    { 
                      ...
                      { 
                        if($r->course_id==$r1->course_id && $r->student_id==$r2->student_id)
                        { 
                  ?>
                <tbody>
                  <tr>
            ...
            <div class="col-xl-6 bg-info">
            	<header class="panel-heading">
	               <h1>Instructor Enroll Details</h1>
	            </header>
              <table class="table table-striped table-advance table-hover">
                <thead>
                  <tr>
                    <th><i class="icon_profile"></i> Instructor ID</th>
                    <th><i class="icon_profile"></i> Course ID</th> 
                    <th><i class="icon_profile"></i> Enrolled course</th>
                    <th><i class="icon_profile"></i> Instructor Name</th>      
                  </tr>
                </thead>
                <?php
                  foreach($records as $r)
                  {
                    ...
                    { 
                      ...
                      { 
                        if($r->course_id==$r1->course_id && $r->id==$r3->id)
                        { 
                  ?>
                <tbody>
                  <tr>
