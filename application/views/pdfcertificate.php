  ...
  display: table;
	...
	<div class="stl_view" >
		<div class="stl_05 stl_06">
				   <div class="row" >
			  <div class="column">
			    <img src="<?=base_url();?>assets2/assets/img/easylogo.jpeg" alt="Snow" style="width: 1300px;">
			  </div>
			  <div class="column">
			    
			  </div>
			  <div class="column">
			    <img src="<?=base_url();?>assets2/assets/img/ciss-academy_logo.png" alt="Mountains" style="width: 1400px;">
			  </div>
			</div>
