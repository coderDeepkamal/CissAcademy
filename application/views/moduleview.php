              ...
              <div class="card">
                ...
                <div class="card-header" role="tab" id="headingTwo2">
                  <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#<?php echo $r1->module_id;?>"
                    ...
                    <h1 class="mb-0">
                      <?= $r1->module_name ?> <i class="menu-arrow arrow_carrot-right"></i><a href="<?php echo base_url();?>Mycontroller/deletemodule/<?php echo $r1->module_id;?>/<?php echo $r1->course_id;?>" class="btn btn-danger" onclick='return checkdelete()'><i class="icon_close_alt2"></i></a>
                      <a href="<?= base_url(); ?>Questions/viewquiz/<?php echo $r1->module_id;?>" target="iframe_a" class="btn btn-info">Test</a>
                    </h1>
                  </a>
                </div>
                ...
                <div id="<?php echo $r1->module_id;?>" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                  ...
                  <div class="card-body">
                   ...
                   ?>
                            ...
                            <td>
                              <a class="btn btn-danger" href="<?php echo base_url();?>Mycontroller/deletecontent/<?php echo $r2->content_id;?>/<?php echo $r2->course_id;?>"><i class="icon_close_alt2"></i></a>
                            </td>
                        <?php 
                          }
                          elseif($r2->status==0)
